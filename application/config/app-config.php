...
*
*/
define('APP_BASE_URL_DEFAULT', 'https://82.29.165.22/');
...
*/
define('APP_ENC_KEY', 'e18ebcfbf2b5c839089b1f63ea3bf9b0');
 ...
 */
define('APP_DB_USERNAME_DEFAULT', 'dotonecrm_vikaas');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD_DEFAULT', 'vikaas_TDB_@97');
