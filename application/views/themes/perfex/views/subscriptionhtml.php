        ...
        <div class="container preview-sticky-container">
            <div class="sm:tw-flex sm:tw-justify-between -tw-mx-4">
                <div class="sm:tw-self-end">
                    <h4 class="bold tw-my-0 subscription-html-name"><?php echo ($subscription->name); ?></h4>
            ...
            <div class="row mtop20">
                ...
                <div class="col-sm-6 text-right transaction-html-info-col-right">
                    ...
                    <p class="tw-mb-0 tw-text-normal subscription-date">
                        ...
                        <?php
                            echo (!empty($subscription->stripe_subscription_id) && !empty($subscription->date_subscribed) 
                            // late webhook check
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo ($child_invoice->date); ?></td>
