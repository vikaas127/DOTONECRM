...
.quick-dropdown .dropdown-header{
    color:#fff;
}
body #header li.icon  .quick-span{
    color:#fff;
...
<div id="header">
    ...
    <nav class="main-nav">
            ...
            <div class="tw-flex tw-flex-1 sm:tw-flex-initial">
                ...
                ?>
                    ...
                    <li class="icon tw-relative ltr:tw-mr-1.5 rtl:tw-ml-1.5" title="<?php echo _l('quick_create'); ?>"
                        ...
                        <ul class="dropdown-menu dropdown-menu-right animated fadeIn tw-text-base quick-dropdown">
                        ...
                        foreach ($item['href_attributes'] as $key => $val) {
                            ...
                            <li>
                                <a href="<?php echo ($url); ?>" <?php echo $href_attributes; ?>
                                    ...
                                    <?php } ?>
                                    <span class="quick-span" style="background: transparent !important">
                                        <?php echo ($item['name']); ?>
                                    </span>
                                </a>
                            </li>
        ...
        echo '</li>';?>
                        ...
                        <!-- <li class=" dropdown tw-relative tw-block notifications-wrapper header-notifications rtl:tw-ml-3"
                    data-toggle="tooltip" title="<?php echo _l('nav_notifications'); ?>" data-placement="bottom">notifications
                    <?php $this->load->view('admin/includes/notifications'); ?>
