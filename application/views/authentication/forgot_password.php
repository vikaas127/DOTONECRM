...
<div class="col-md-5 col-lg-5  left-box">
                ...
                <div class="login-form">
                            ...
                            <h1 class="tw-font-semibold text-center" style="color:rgb(25, 25, 25)!important; margin-bottom: 20px;">
                            ...
                            <div class="form-group">
                             ...
                             <div  style=" display: flex;">
                                    <a href="<?php echo site_url('admin/authentication'); ?>" class="btn-link" style="margin-left: auto;">
                                        Back to Login!
                                    </a>
                </div>
