...
function get_required_fields_for_registration()
{
    ...
    return [
        'contact' => [
            'contact_firstname' => ['label' => _l('clients_firstname'), 'is_required' => true, 'disabled' => false],
            'contact_lastname' => ['label' => _l('clients_lastname'), 'is_required' => true, 'disabled' => false],
