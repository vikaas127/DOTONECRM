...
body #wrapper .dataTables_wrapper .table tr th::after {
    filter: invert(0);
}

body #wrapper .dataTables_wrapper .table tr th {
                  ...
                  <div role="tabpanel" class="tab-pane active" id="interview_infor">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                  <?php echo render_input('sort_name', 'short_commodity_name'); ?>
                                </div>
                                <div class="col-md-4">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3">
                                ...
                                <?php echo render_input('sku_code', 'sku_code','','text'); ?>
                              </div>
                              <div class="col-md-3">
