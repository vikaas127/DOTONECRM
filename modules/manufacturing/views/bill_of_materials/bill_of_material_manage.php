...
<div id="wrapper">
    ...
    <?php } ?>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<?php if(has_permission('manufacturing','','delete')&&has_permission('bill_of_material','','delete') || is_admin()){ ?>
						...
						<?php if (has_permission('manufacturing','','delete')&&has_permission('bill_of_material','','delete')) { ?>
...
<script>
function copyBOM(bomId) {
    if (confirm("Are you sure you want to copy this BOM?")) {
        window.location.href = "<?php echo admin_url('manufacturing/copy_bom/'); ?>" + bomId;
    }
}
</script>
