...
<table border="1" cellpadding="8" style="border-collapse: collapse; width: 100%; text-align: left;">
    ...
    <tbody>
        <tr>
            <td>TechDotBit</td>
            <td>TechDotBit Support</td>
            <td>+91 94731 59639</td>
            <td>Support@techdotbit.com</td>
        </tr>
        <tr>
            <td>{$company}</td>
            <td>{$client_name}</td>
...
<h3 style="text-align: center; font-size: 18px; margin-top: 40px; text-decoration: underline;">NOTE</h3>

<p style="font-size: 14px; line-height: 1.6; text-align: justify; margin-top: 20px;">
    This Memorandum of Understanding (MoU)/Non-Disclosure Agreement (NDA) shall be considered valid and legally binding upon the user’s successful registration on the <strong>TechDotBit</strong> platform. By completing the registration process, the user confirms and explicitly agrees to the platform’s <strong>Terms and Conditions</strong> and <strong>Privacy Policy</strong>. 
</p>

<p style="font-size: 14px; line-height: 1.6; text-align: justify;">
    The user’s acceptance through electronic acknowledgment during registration shall constitute full and enforceable consent, in accordance with applicable laws governing electronic contracts and digital agreements. No physical signature is required, and this acknowledgment shall carry the same legal effect as a manually signed document.
</p>
